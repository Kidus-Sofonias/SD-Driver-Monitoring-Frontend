...
type TranslationKey =
  ...
  | "trips_in_each_period"
  | "all_driver_trips"
  | "back_to_drivers"
  | "started_time"
  | "finished_time"
  | "score_badge"
  | "no_scored_trips_for_driver"
  | "expanded_analysis"
  | "weekly_graph"
  | "monthly_graph"
  | "close"
...
const translations: Record<LanguageMode, Partial<Record<TranslationKey, string>>> = {
  en: {
    ...
    model_influence: "Model influence",
    ...
    scored_trips: "Scored trips",
    high_risk_trips: "High-risk trips",
    last_trip_label: "Last trip",
    improvement_tracking: "Improvement tracking",
    driver_trend_graph: "Driver trend graph",
    weekly: "Weekly",
    monthly: "Monthly",
    maximize_graph: "Maximize graph",
    trend_chart_hint: "Switch between weekly and monthly views. Expand the graph when you want more room to inspect the trend.",
    current_avg: "Current avg",
    previous_avg: "Previous avg",
    trips_in_period: "Trips in period",
    weekly_trend: "Weekly trend",
    monthly_trend: "Monthly trend",
    last_8_weeks: "Last 8 weeks",
    last_6_months: "Last 6 months",
    average_safety_score: "Average safety score",
    trips_in_each_period: "Trips in each period",
    all_driver_trips: "All driver trips",
    back_to_drivers: "Back to drivers",
    started_time: "Started {time}",
    finished_time: "Finished {time}",
    score_badge: "Score {score}",
    no_scored_trips_for_driver: "This driver has no scored trips yet.",
    expanded_analysis: "Expanded analysis",
  ...
  am: {
    ...
    finalize_again: "እንደገና ጨርስ",
    open_trip_results: "የጉዞ ውጤቶችን ክፈት",
    no_active_trip_prompt: "አሁን ንቁ ጉዞ የለም። መከታተል ለመጀመር ጉዞ ጀምር።",
    sync_sensor_batch: "የሴንሰር ቡድን አመሳስል",
    drivers: "አሽከርካሪዎች",
    driver_record: "የአሽከርካሪ መዝገብ",
    workspace: "የስራ ቦታ",
    app_tagline: "የቀጥታ ጉዞ መረጃ፣ AI ውጤት እና የአሽከርካሪ ግምገማ በአንድ ቦታ።",
    samples_queued: "የተደረደሩ ሳምፕሎች",
    admin_ops: "የአስተዳዳሪ ስራዎች",
    driver_safety_command: "የአሽከርካሪ ደህንነት ማዕከል",
    admin_dashboard_intro: "የመርከብ አደጋን ይገምግሙ፣ ጠንካራ አሽከርካሪዎችን ያግኙ፣ እና የሰው ትኩረት የሚፈልጉ ጉዞዎችን በቀጥታ ይክፈቱ።",
    trips_tracked: "የተከታተሉ ጉዞዎች",
    need_review: "ግምገማ ያስፈልጋቸዋል",
    average_score: "አማካይ ነጥብ",
    average_confidence: "አማካይ እምነት",
    trips_word: "ጉዞዎች",
    high_risk: "ከፍተኛ አደጋ",
    best_driver: "ምርጥ አሽከርካሪ",
    top_performer: "ከፍተኛ አፈጻጸም",
    open_latest_trip: "የመጨረሻ ጉዞ ክፈት",
    top_performer_help: "ከፍተኛ አፈጻጸም የሚታየው አሽከርካሪ ቢያንስ 5 የተጠናቀቁ ጉዞዎች ሲኖሩት ነው።",
    drivers_to_watch: "መከታተል ያለባቸው አሽከርካሪዎች",
    attention_queue: "የትኩረት ወረፋ",
    open_review: "ግምገማ ክፈት",
    pending_reviews_high_risk: "{pending} በመጠባበቅ ላይ ያሉ ግምገማዎች፣ {highRisk} ከፍተኛ አደጋ ጉዞዎች",
    no_watchlist_pressure: "እስካሁን የክትትል ጫና የለም።",
    risk_mix: "የአደጋ ድብልቅ",
    fleet_risk_breakdown: "የመርከብ አደጋ ክፍፍል",
    score_distribution: "የነጥብ ስርጭት",
    trips_by_score_band: "በነጥብ ክልል የተከፋፈሉ ጉዞዎች",
    recent_activity: "የቅርብ ጊዜ እንቅስቃሴ",
    trips_that_just_landed: "አሁን የደረሱ ጉዞዎች",
    waiting: "{count} በመጠባበቅ ላይ",
    driver_directory: "የአሽከርካሪ ማውጫ",
    manage_fleet_access: "የመርከብ መዳረሻን ያስተዳድሩ",
    driver_directory_intro: "የማንኛውንም አሽከርካሪ መዝገብ ይክፈቱ፣ ጉዞዎቻቸውን ይመርምሩ፣ ማስረጃዎችን ያሽከርክሩ፣ ወይም መዳረሻን ያስወግዱ።",
    all_drivers: "ሁሉም አሽከርካሪዎች",
    active_accounts: "{count} ንቁ መለያዎች",
    search_drivers: "አሽከርካሪዎችን ይፈልጉ",
    search_driver_placeholder: "በኢሜይል ይፈልጉ",
    drivers_matching: "{count} የሚዛመዱ አሽከርካሪዎች",
    trips_recorded: "{count} የተመዘገቡ ጉዞዎች",
    last_trip: "የመጨረሻ ጉዞ፡ {time}",
    no_driver_accounts: "እስካሁን የአሽከርካሪ መለያዎች አልተፈጠሩም።",
    no_drivers_match_search: "ከፍለጋህ ጋር የሚዛመድ አሽከርካሪ የለም።",
    edit_credentials: "ማስረጃዎችን አርትዕ",
    new_password: "አዲስ የይለፍ ቃል",
    leave_blank_keep_password: "የአሁኑን የይለፍ ቃል ለማቆየት ባዶ ይተው",
    cancel: "ሰርዝ",
    save: "አስቀምጥ",
    delete: "አጥፋ",
    delete_driver: "አሽከርካሪ ሰርዝ",
    delete_driver_confirm: "{email} እና ሁሉንም ጉዞዎቻቸውን ይሰርዙ? ይህ ሊቀለበስ አይችልም።",
    uploading_live_samples: "የቀጥታ ሳምፕሎች በመሰብሰብ ላይ",
    samples_waiting_sync: "{count} ሳምፕሎች ለማመሳሰል በመጠባበቅ ላይ",
    last_synced_time: "የመጨረሻ ጊዜ የተመሳሰለ {time}",
    edit: "አርትዕ",
    overall_score: "አጠቃላይ ነጥብ",
    scored_trips: "የተመዘገቡ ጉዞዎች",
    high_risk_trips: "ከፍተኛ አደጋ ጉዞዎች",
    last_trip_label: "የመጨረሻ ጉዞ",
    improvement_tracking: "የመሻሻል ክትትል",
    driver_trend_graph: "የአሽከርካሪ አዝማሚያ ግራፍ",
    weekly: "ሳምንታዊ",
    monthly: "ወርሃዊ",
    maximize_graph: "ግራፉን አሳድግ",
    trend_chart_hint: "በሳምንታዊ እና ወርሃዊ እይታዎች መካከል ይቀይሩ። አዝማሚያውን ለመመርመር ተጨማሪ ቦታ ሲፈልጉ ግራፉን ያስፉ።",
    current_avg: "የአሁኑ አማካይ",
    previous_avg: "የቀድሞው አማካይ",
    trips_in_period: "በወቅቱ ጉዞዎች",
    weekly_trend: "ሳምንታዊ አዝማሚያ",
    monthly_trend: "ወርሃዊ አዝማሚያ",
    last_8_weeks: "የመጨረሻ 8 ሳምንታት",
    last_6_months: "የመጨረሻ 6 ወራት",
    average_safety_score: "አማካይ የደህንነት ነጥብ",
    trips_in_each_period: "በእያንዳንዱ ወቅት ጉዞዎች",
    all_driver_trips: "ሁሉም የአሽከርካሪ ጉዞዎች",
    back_to_drivers: "ወደ አሽከርካሪዎች ተመለስ",
    started_time: "የጀመረበት {time}",
    finished_time: "ያበቃበት {time}",
    score_badge: "ነጥብ {score}",
    no_scored_trips_for_driver: "ይህ አሽከርካሪ እስካሁን የተመዘገቡ ጉዞዎች የሉትም።",
    expanded_analysis: "የተስፋፋ ትንተና",
    weekly_graph: "ሳምንታዊ ግራፍ",
  ...
  om: {
    ...
    trip_details: "Ibsa imalaa",
    review_dashboard: "Boordii gamaaggamaa",
    settings: "Qindaa'ina",
    loading_app: "Appiin fe'amaa jirti...",
    signed_in_as: "Akka kanaan seente",
    driver_account: "Herrega oftootaa",
    theme: "Bifa",
    light: "Ifaa",
    dark: "Dukkana",
    language: "Afaan",
    ...
    drive_overview: "Ilaalcha oofuu",
    dashboard_intro: "Haala imalaa yeroo dhugaa, qabxii dhiyoo, fi taateewwan uumaman bakka tokko keessatti.",
    today_score: "Qabxii har'aa",
    risk: "Balaa",
    confidence: "Amanamummaa",
    events: "Taateewwan",
    trip_lifecycle: "Marsaa imalaa",
    active_trip_monitor: "Hordoffii imalaa itti jiru",
    trip_in_progress: "Imalli itti jira",
    ready_to_finalize: "Xumuruuf qophii",
    no_active_trip: "Imalli itti jiru hin jiru",
    elapsed_time: "Yeroo darbe",
    ended_at: "Yeroo itti xumurame",
    samples_uploaded: "Sampileen ol ba'an",
    samples_queued: "Sampileen tarreefaman",
    sync_status: "Haala walsimsiisaa",
    live: "Yeroo dhugaa",
    paused: "Dhaabbate",
    idle: "Hojii malee",
    current_upload_health: "Haala ol-ba'ii ammaa",
    last_sensor_batch: "Tuuta seensorii dhumaa {time} ol ba'e.",
    trip_ready_processing: "Imalli kun xumurameera; itti fufiinsa xumuraaf qophii dha.",
    start_trip_prompt: "Hordoffii jalqabuuf imala jalqabi.",
    open_trip: "Imala bani",
    end_trip: "Imala xumuri",
    open_active_trip_page: "Fuula imalaa itti jiru bani",
    start_trip: "Imala jalqabi",
    previous_finalized_trip: "Imala duraan xumurame",
    trip_result: "Bu'aa imalaa",
    open_results: "Bu'aa bani",
    no_finalized_trip: "Imalli xumurame hin jiru",
    finalize_trip_help: "Qabxii, balaa, amanamummaa, sababoota fi taateewwan as argachuuf imala xumuri.",
    top_reasons: "Sababoota gurguddoo",
    recent_trips: "Imaloota dhiyoo",
    no_finalized_trips_yet: "Imaloonni xumuraman hin jiran",
    finalized_trips_history_help: "Imaloonni xumuraman as ni mul'atu; fuula ibsaa keessaa banamu.",
    generated_events: "Taateewwan uumaman",
    latest_event_summary: "Cuunfaa taateewwanii dhiyoo",
    generated_events_empty: "Taateewwan uumaman erga imalli xumuramee booda as ni mul'atu.",
    latest_trip_result: "Bu'aa imalaa dhiyoo",
    awaiting_finalized_trip: "Imala xumurame eeggachaa jira",
    results_page_live: "Fuulli kun imala dhumaa xumurame kan backend itti fufiinsa xumuree booda deebise argisiisa.",
    results_page_fallback: "Fuulli kun imala dhiyoo xumurame kan backend keessatti kuusame dubbisa.",
    results_page_empty: "Imala xumuri; backend qabxii, balaa, amanamummaa, sababoota fi taateewwan uumaman fuula kana guuta.",
    probability: "Iti-ta'umsa",
    processed: "Itti fufiinsa xumurame",
    no_reasons_yet: "Sababootni imalaa hin jiran.",
    events_empty_after_finalize: "Kaardoonni taateewwanii erga imalli xumuramee booda as ni mul'atu.",
    choose_trip_details: "Imala xumurame seenaa irraa filadhu; ibsa guutuu isaa bani.",
    back_to_history: "Gara seenaatti deebi'i",
    reasons: "Sababoota",
    no_reasons_for_trip: "Imala kanaaf sababootni hin uumamne.",
    no_events_for_trip: "Imala kanaaf taateewwan hin jiran.",
    ...
    finalized_trip_review: "Gamaaggama imalaa xumurame",
    items_need_review: "{count} wantoota gamaaggama barbaadan",
    review_empty: "Dura imaloota muraasa xumuri; gamaaggamaaf as ni mul'atu.",
    ...
    selected_trip: "Imala filatame",
    trip_review_detail: "Ibsa gamaaggama imalaa",
    trip_id: "Paastoo imalaa",
    predicted_label: "Mallattoo dursee himame",
    rule_score: "Qabxii seeraa",
    model_influence: "Dhiibbaa moodeelii",
    review_notes: "Yaadannoo gamaaggamaa",
    review_notes_placeholder: "Sababa gamaaggama kee itti dabali",
    mark_safe: "Nageenya qaba jedhi",
    mark_risky: "Balaa qaba jedhi",
    clear_label: "Mallattoo haqi",
    events_label: "Taateewwan",
    no_events: "Taateewwan hin jiran",
    all_trips_history: "Seenaa imalootaa hunda",
    latest_finalized_trip: "Imala dhiyoo xumurame",
    post_analysis_summary: "Cuunfaa itti fufiinsa boodaa",
    trip_ended: "Imalli xumurame",
    started: "Jalqabe",
    finalize_trip: "Imala xumuri",
    finalize_again: "Amma deebi'ii xumuri",
    open_trip_results: "Bu'aa imalaa bani",
    no_active_trip_prompt: "Amma imalli itti jiru hin jiru. Hordoffii jalqabuuf imala jalqabi.",
    sync_sensor_batch: "Tuuta seensorii walsimsiisi",
    uploading_live_samples: "Sampileen yeroo dhugaa walitti qabamoo jira",
    samples_waiting_sync: "{count} sampileen walsimsiisuu eeggachaa jiran",
    last_synced_time: "Yeroo dhumaa walsimsiifame {time}",
    edit: "Gulaali",
    overall_score: "Qabxii waliigalaa",
    scored_trips: "Imaloota qabxii qaban",
    high_risk_trips: "Imaloota balaa olaanaa",
    last_trip_label: "Imala dhumaa",
    improvement_tracking: "Hordoffii fooyya'iinsaa",
    driver_trend_graph: "Graafii dalagaa oftuu",
    weekly: "Torbeessaa",
    monthly: "Ji'ootaa",
    maximize_graph: "Graafii guddisi",
    trend_chart_hint: "Gidduu ilaallacha torbeessaa fi ji'ootaa jijjiiri. Yeroo dalagaa itti ilaaluuf bakka dabalataa barbaaddetti graafii guddisi.",
    current_avg: "Gidduugaleessa ammaa",
    previous_avg: "Gidduugaleessa duraa",
    trips_in_period: "Imaloota yeroo sana keessa",
    weekly_trend: "Dalagaa torbeessaa",
    monthly_trend: "Dalagaa ji'ootaa",
    last_8_weeks: "Torban 8 dhumaa",
    last_6_months: "Ji'a 6 dhumaa",
    average_safety_score: "Qabxii nageenyaa gidduugaleessaa",
    trips_in_each_period: "Imaloota yeroo tokko tokkoo keessa",
    all_driver_trips: "Imaloota oftuu hunda",
    back_to_drivers: "Gara oftootaa deebi'i",
    started_time: "Yeroo itti jalqabame {time}",
    finished_time: "Yeroo itti xumurame {time}",
    score_badge: "Qabxii {score}",
    no_scored_trips_for_driver: "Oftuun kun imala qabxii qabu hin qabu.",
    expanded_analysis: "Xiinxala bal'aa",
    weekly_graph: "Graafii torbeessaa",
